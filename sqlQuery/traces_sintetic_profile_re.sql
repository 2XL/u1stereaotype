stereo_sintetic_profile_re.sql

drop table if exists traces_sintetic_profile_re;
create table traces_sintetic_profile_re(
profile string,
-- t string,
ext string,
-- logfile_id string,
...
insert into traces_sintetic_profile_re
select 'backup_20_heavy', ext, node_id, req_t, sid, tstamp, type, user_id, size
from traces_sintetic.traces_sintetic_re 
...
show table stats traces_sintetic_profile_re;
